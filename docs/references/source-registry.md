...
| DOC-MPAS-ATM-RUN-001 | MPAS-Model 8.4.1 | [`Registry.xml` do atmosphere](https://github.com/MPAS-Dev/MPAS-Model/blob/v8.4.1/src/core_atmosphere/Registry.xml), [`mpas_atmphys_control.F`](https://github.com/MPAS-Dev/MPAS-Model/blob/v8.4.1/src/core_atmosphere/physics/mpas_atmphys_control.F), defaults e stream lists gerados na imagem | `dt`, relógio, LBC/restart/SST/radiação, resolução exata de `mesoscale_reference`, streams e lookup tables | source commit `91c5eac...` inspecionado e execução real exercitada em 2026-08-21; autoridade operacional do ciclo 0013 |
| DOC-MPAS-ATM-RUN-002 | MPAS oficial | [Running MPAS](https://www2.mmm.ucar.edu/projects/mpas/site/documentation/users_guide/running.html), [Configuring I/O](https://www2.mmm.ucar.edu/projects/mpas/site/documentation/users_guide/configuring_io.html), [Model options](https://www2.mmm.ucar.edu/projects/mpas/site/documentation/users_guide/model_options.html) e [tutorial St Andrews 2025](https://www2.mmm.ucar.edu/projects/mpas/tutorial/StAndrews2025/) | cold start, streams, atualização de SST e baseline x1.10242 com `dt=1200 s`, radiação horária e tabelas de física | consultados em 2026-08-21 e subordinados ao source exato 8.4.1 quando há diferença |
