...
| Bibliotecas adotadas até agora | zlib 1.3.2, HDF5 1.14.6, netCDF-C 4.10.1 e netCDF-Fortran 4.6.3 | argumentos de build no `Dockerfile` |
...
- versões de PnetCDF, PIO2, METIS, WPS e MPAS;
- estratégia formal serial/paralela do HDF5 e do netCDF para a stack completa;
