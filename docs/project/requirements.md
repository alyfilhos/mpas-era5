...
| Bibliotecas adotadas até agora | zlib 1.3.2, HDF5 1.14.6, netCDF-C 4.10.1, netCDF-Fortran 4.6.3, PnetCDF 1.15.0 e PIO 2.7.0 | argumentos de build no `Dockerfile` |
